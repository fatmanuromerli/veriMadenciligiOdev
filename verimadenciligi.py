...
for i in selected_columns:
    iqr_aykiri_degerleri_bul(df, i, 1.5)
    aykiri_degerleri_sil(df, i, 1.5)
    
print("-------ortalama değerleri aykırı değerlerden sonra--------------")
for i in selected_columns:
    a = sutun_ortalama_degeri(df, i)
    print(i,a)
print("-------ortanca değerleri aykırı değerlerden sonra--------------")
for i in selected_columns:
    ortanca = sutun_ortanca_degerleri(df, i)
    print(i,ortanca)
print("-------mod değerleri aykırı değerlerden sonra--------------")
for i in selected_columns:
    m = sutun_ortalama_degeri(df, i)
    print(i,m)    
print("-------standart sapma değerleri aykırı değerlerden sonra--------------")
for i in selected_columns:
    s = sutun_standart_sapma(df, i)
    print(i,s)  
print("-------varyans değerleri aykırı değerlerden sonra--------------")
for i in selected_columns:
    v = sutun_varyans(df, i)
    print(i,v)
print("-------mod değerleriaykırı değerlerden sonra--------------")  
for i in selected_columns:
    v = sutun_varyans(df, i)
    print(i,v)
